...
class AzureBlob(C2Profile):
    ...
    parameters = [
        ...
        # Auto-populated by PayloadType.build() - not shown in UI for manual entry
        C2ProfileParameter(
            name="container_name",
            description="Agent's container (auto-generated by PayloadType)",
            default_value="",
            required=False,
        ),
        C2ProfileParameter(
            name="container_sas",
            description="Container-scoped SAS token (auto-generated by PayloadType)",
            default_value="",
            required=False,
        ),
        C2ProfileParameter(
